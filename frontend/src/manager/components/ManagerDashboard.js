...
const ManagerDashboard = () => {
  ...
  return (
    <div className="bg-[#E9E4E4] p-8 min-h-screen">    
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Restaurants Card */}
        <div className="bg-[#262B3E] rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          <div className="bg-[#276265] h-2"></div>
          <div className="p-6">
            <div className="bg-[#262B3E]/80 rounded-full w-16 h-16 flex items-center justify-center mb-4">
            ...
            <h2 className="text-2xl font-semibold text-white mb-2">Restaurants</h2>
            <p className="text-gray-300 mb-6">Manage your restaurant portfolio</p>
            <button 
        ...
        <div className="bg-[#262B3E] rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="p-6">
            ...
            <h2 className="text-2xl font-semibold text-white mb-2">Reservations</h2>
            <p className="text-gray-300 mb-6">Track and manage bookings</p>
            <button 
              className="w-full py-2 px-4 bg-[#276265] text-white rounded-lg hover:bg-[#276265]/80 transition-colors duration-300 flex items-center justify-center"
        ...
        <div className="bg-[#262B3E] rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="p-6">
            ...
            <h2 className="text-2xl font-semibold text-white mb-2">Orders</h2>
        ...
        <div className="bg-[#262B3E] rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-300 mb-6">View business performance</p>
            <button 
              className="w-full py-2 px-4 bg-[#276265] text-white rounded-lg hover:bg-[#276265]/80 transition-colors duration-300 flex items-center justify-center"
