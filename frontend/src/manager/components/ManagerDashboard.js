      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-blue-100 text-gray-700 rounded-lg hover:bg-blue-200 transition-colors duration-300 flex items-center justify-center"
        ...
        {/* Reservations Card */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          <div className="bg-indigo-100 h-2"></div>
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-indigo-100 text-gray-700 rounded-lg hover:bg-indigo-200 transition-colors duration-300 flex items-center justify-center"
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-green-100 text-gray-700 rounded-lg hover:bg-green-200 transition-colors duration-300 flex items-center justify-center"
        ...
        {/* Profile Card */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          <div className="bg-pink-100 h-2"></div>
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-pink-100 text-gray-700 rounded-lg hover:bg-pink-200 transition-colors duration-300 flex items-center justify-center"
        ...
        {/* Quick Actions Card */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          <div className="bg-purple-100 h-2"></div>
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-purple-100 text-gray-700 rounded-lg hover:bg-purple-200 transition-colors duration-300 flex items-center justify-center"
        ...
        {/* Analytics Card */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
          <div className="bg-teal-100 h-2"></div>
          <div className="p-6">
            ...
            <button 
              className="w-full py-2 px-4 bg-teal-100 text-gray-700 rounded-lg hover:bg-teal-200 transition-colors duration-300 flex items-center justify-center"
