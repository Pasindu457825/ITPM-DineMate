...
import { User, LogOut, Menu, X, ChevronDown, Home, Pizza, CalendarCheck, ShoppingBag, Bell } from 'lucide-react';
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-3">
            <Link to="/managers" onClick={closeAllMenus} className="flex items-center space-x-2 group">
              ...
              <span className="font-bold text-xl tracking-tight text-amber-700">Dinemate</span>
            </Link>
              ...
              {isRestaurantDropdownOpen && (
                <div className="absolute left-0 mt-2 w-56 bg-white text-gray-700 rounded-lg shadow-xl py-1.5 z-10 border border-gray-100 overflow-hidden">
                  <div className="py-1 bg-amber-50 px-3 mb-1.5">
                    <p className="text-xs font-medium text-amber-700 uppercase tracking-wider">Restaurant Management</p>
                  </div>
                  <Link 
                    to="/my-restaurant" 
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white text-gray-700 rounded-lg shadow-xl py-2 z-10 border border-gray-100">
                ...
                <Link 
                  ...
                  className="flex items-center px-4 py-2.5 hover:bg-amber-50 transition-colors duration-200"
                >
                  <svg className="mr-3 h-4 w-4 text-amber-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
