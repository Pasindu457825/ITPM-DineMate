    ...
    <div className="p-6 bg-gray-200 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-2xl bg-blue-gray-900 rounded-lg shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-5">
          ...
          <p className="text-blue-200 text-sm">Complete the form below to add a delicious new item to your menu</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-blue-gray-400 text-xs text-right">{description.length}/50 characters</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className={`border-2 border-dashed rounded-lg p-4 text-center ${
              errors.imageFile ? "border-red-500" : "border-blue-gray-600"
            }`}>
              <input
                type="file"
                accept="image/*"
            ...
            {errors.imageFile && <p className="text-red-500 text-xs">{errors.imageFile}</p>}
          </div>
